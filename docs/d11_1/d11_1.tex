...
``Bill is no golfer'', which are distinct ACE sentences having different
DRSs (although which are interpreted as semantically equivalent).
...
all the 19,422 Codeco test sentences in 55 seconds
