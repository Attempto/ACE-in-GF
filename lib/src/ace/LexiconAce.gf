...
concrete LexiconAce of Lexicon = CatAce ** 
  open ParadigmsAce, IrregAce, Prelude in {
...
lin
 ...
 ---- trousers_N = regN "trousers" ;
  ...
  worm_N = regN "worm" ;
  year_N = regN "year" ;
  blow_V = IrregAce.blow_V ;
  breathe_V = dirV2 (regV "breathe") ;
  burn_V = IrregAce.burn_V ;
  dig_V = IrregAce.dig_V ;
  fall_V = IrregAce.fall_V ;
  float_V = regV "float" ;
  flow_V = regV "flow" ;
  fly_V = IrregAce.fly_V ;
  freeze_V = IrregAce.freeze_V ;
  give_V3 = dirV3 give_V toP ;
  laugh_V = regV "laugh" ;
  lie_V = IrregAce.lie_V ;
  play_V = regV "play" ;
  sew_V = IrregAce.sew_V ;
  sing_V = IrregAce.sing_V ;
  sit_V = IrregAce.sit_V ;
  smell_V = regV "smell" ;
  spit_V = IrregAce.spit_V ;
  stand_V = IrregAce.stand_V ;
  swell_V = IrregAce.swell_V ;
  swim_V = IrregAce.swim_V ;
  think_V = IrregAce.think_V ;
  turn_V = regV "turn" ;
  vomit_V = mkV "vomit" "vomited" ;

  bite_V2 = dirV2 IrregAce.bite_V ;
  count_V2 = dirV2 (regV "count") ;
  cut_V2 = dirV2 IrregAce.cut_V ;
