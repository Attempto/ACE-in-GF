...
--
-- The main difference with $MorphoAce.gf$ is that the types
...
-- separate module [``IrregAce`` ../../english/IrregAce.gf], 
-- which covers irregular verbss.

resource ParadigmsAce = open 
  (Predef=Predef), 
  Prelude, 
  MorphoAce,
  ResAce,
...
-- prefix-variants of irregular verbs from $IrregAce$, e.g. "undertake".
...
-- hidden from the document.
  ...
  Gender = ResAce.Gender ; 
  Number = ResAce.Number ;
  Case = ResAce.NPCase ;
  human = Masc ; 
  nonhuman = Neutr ;
  masculine = Masc ;
