...
lin
  ...
  see_V2 = mkV2 (mkV "redzēt" third_conjugation) ;
  buy_V2 = mkV2 (mkV "pirkt" "pērku" "pirku") ;
  help_V2 = mkV2 (mkV "palīdzēt" third_conjugation) dat_Prep ;
  admire_V2 = mkV2 (mkV "apbrīnot" second_conjugation) ;
  love_V2 = mkV2 (mkV "patikt" "patīku" "patiku" Dat) nom_Prep ; -- "patikt" instead of "mīlēt" to test the Dat-Nom valence
  inspect_V2 = mkV2 (mkV "apskatīt" third_conjugation) ;
